    ...
    items: [
      {
        ...
        to: '/admin/cases',
        icon: 'cases',
        isActive: route.path.startsWith('/admin/cases'),
      },
      {
        label: 'Orders',
      ...
      <header class="admin-topbar">
        ...
        <div class="admin-topbar__actions">
          ...
          <div class="admin-topbar__buttons">
            <button class="admin-topbar-action-btn admin-topbar-action-btn--light theme-toggle" type="button" @click="toggleTheme" title="Toggle Theme">
              ...
              <span class="action-text">{{ theme === 'dark' ? 'Light' : 'Dark' }}</span>
            </button>
            <NotificationBell />
